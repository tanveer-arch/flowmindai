...
# Add project paths so both agent.py and backend imports work
# agent_runner.py is at: flowmind/FlowMind/backend/runtime/agent_runner.py
# agent.py is at:        flowmind/agent.py
# backend/ is at:        flowmind/FlowMind/backend/

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))          # .../runtime/
FLOWMIND_PKG = os.path.dirname(os.path.dirname(SCRIPT_DIR))       # .../FlowMind/
WORKSPACE_ROOT = os.path.dirname(FLOWMIND_PKG)                    # .../flowmind/

sys.path.insert(0, WORKSPACE_ROOT)    # so "import agent" finds flowmind/agent.py
sys.path.insert(0, FLOWMIND_PKG)      # so "from backend..." finds FlowMind/backend/
